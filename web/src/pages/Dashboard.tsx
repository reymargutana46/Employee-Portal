...
const Dashboard = () => {
  ...
  const safeCard = useMemo(() => ({
    ...
    facultyByGrade: card?.facultyByGrade || { kinder: 0, grade1: 0, grade2: 0, grade3: 0, grade4: 0, grade5: 0, grade6: 0, staff: 0 },
    workloadStats: card?.workloadStats || { total: 0, approved: 0, disapproved: 0 },
    leaveStats: card?.leaveStats || { total: 0, pending: 0, approved: 0, rejected: 0 },
  }), [card]);
  ...
  return (
    <div className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
      ...
      {userRole && userRole.name.toLowerCase() === 'staff' ? (
        ...
        // Secretary-specific layout with detailed information
            ...
            <Card className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900 border-blue-200 dark:border-blue-800">
              ...
              <CardContent>
                ...
                <div className="grid grid-cols-3 gap-2 text-xs mt-2">
                  <div className="text-center">
                    <div className="font-medium">
                      {safeCard.facultyByGrade?.kinder || 0}
                    </div>
                    <div className="text-muted-foreground">Kinder</div>
                  </div>
                  <div className="text-center">
